<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ url('home') }}">PPDBSMKTI</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ url('home') }}">PSTI</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Modul
                        Pendaftaran</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-plug"></i> <span>Modul
                        Sekolah</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#" data-toggle="modal" data-target="#modalJurusan">Jurusan</a>
                    </li>
                    <li><a class="nav-link" href="#" data-toggle="modal"
                            data-target="#modalGelombang">Gelombang</a></li>
