...
<div>
    ...
    <a href="#" class="text-nowrap logo-img">
        <img class="mt-3" src="images/logos/smk-pgri.jpg" width="150" alt="" />
    </a>
    ...
    <ul id="sidebarnav">
        ...
        <a class="sidebar-link {{ $page === "dashboard" ? 'active' : '' }}" href="/testing" aria-expanded="false">
            <span>
        ...
        <li class="sidebar-item">
        <a class="sidebar-link {{ $page === "daftarbaru" ? 'active' : '' }}" href="/testing2" aria-expanded="false">
            <span>
        ...
        <a class="sidebar-link" href="./authentication-register.html" aria-expanded="false">
            ...
            <span class="hide-menu">Informasi Slide</span>
        </a>
        </li>
        <li class="sidebar-item">
            <a class="sidebar-link" href="./authentication-register.html" aria-expanded="false">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link" href="./authentication-register.html" aria-expanded="false">
                ...
                <span class="hide-menu">Galeri Sekolah</span>
            </a>
        </li>
        <li class="nav-small-cap">
        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
